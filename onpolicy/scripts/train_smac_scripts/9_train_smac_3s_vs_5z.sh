...
do
    ...
    --num_env_steps ${num_env_steps} --ppo_epoch 15 --clip_param 0.05 --use_value_active_masks --use_eval --eval_episodes 32 --stacked_frames 4 --use_stacked_frames --share_policy \
    --use_wandb 0 \
    --save_models_flag
done
